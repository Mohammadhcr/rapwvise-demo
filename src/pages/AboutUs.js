                ...
                <div className={mySkillsContact}>
                    <div className={myLinks}>
                        ...
                        <div className={myLinksLink}>
                            ...
                            <a className={telegram} href="https://t.me/rapwviser" target="_blank"><i className='bx bxl-telegram'></i> تلگرام</a>
                    ...
                    <div className={myLinks}>
                        ...
                        <div className={myLinksLink}>
                            ...
                            <a className={telegram} href="https://t.me/rapwviser" target="_blank"><i className='bx bxl-telegram'></i> اپل پادکست</a>
